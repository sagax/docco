...
(function() {
  var Docco, _, buildMatchers, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, languages, marked, outputCode, parse, path, run, version, write,
    slice = [].slice;
