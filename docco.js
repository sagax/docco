...
(function() {
  var Docco, buildMatchers, commander, configure, defaults, document, ext, format, fs, getLanguage, highlightjs, languages, marked, outputCode, parse, path, run, version, write, _,
    __slice = [].slice;
