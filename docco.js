...
(function() {
  var Docco, buildMatchers, commander, configure, defaults, diveSync, document, format, fs, getLanguage, highlightjs, languages, marked, parse, path, run, slash, version, write, _,
    __slice = [].slice;
  ...
  write = function(source, sections, config) {
    var assetPath, destination, destinationDir, destinationFile, first, firstSection, hasTitle, html, htmlPath, title;
    destination = function(file, options) {
      var filename, _ref;
      if (options == null) {
        options = {};
      }
      if ((_ref = options.fKeepExtension) != null ? _ref : false) {
  ...
  configure = function(options) {
    var allSources, config, dir, _i, _len, _ref;
