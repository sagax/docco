...
(function() {
  var Docco, buildMatchers, commander, configure, defaults, diveSync, document, format, fs, getLanguage, highlightjs, languages, marked, parse, path, run, version, write, _,
    __slice = [].slice;
  ...
  write = function(source, sections, config) {
    var destination, destinationDir, destinationFile, first, firstSection, hasTitle, html, jumpToFile, title;
