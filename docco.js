...
var Docco, buildMatchers, coffeeSyntax, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, javascriptSyntax, languages, marked, parse, path, run, version, write, _,
  __slice = [].slice;
