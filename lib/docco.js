(function() {
  var arg, args, css_file, destination, docco_scripts, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, inline, l, languages, parse, path, showdown, sources, spawn, structured_output, template, version, _ref;
  version = '0.3.1';
