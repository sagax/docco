...
(function() {
  var buildOutline, commander, defaults, document, ensureDirectory, exec, ext, fs, generateDocumentation, generateHtml, getLanguage, getResource, highlight, highlightEnd, highlightStart, htmlEscape, key, l, languages, parse, path, resolveSource, run, showdown, spawn, template, value, version, _ref, _ref1,
  ...
  buildOutline = function(sections) {
    var heading, index, line, outline, root, section, _i, _j, _len, _len1, _ref;
    outline = [];
    for (index = _i = 0, _len = sections.length; _i < _len; index = ++_i) {
      section = sections[index];
      _ref = section.docsText.split('\n');
