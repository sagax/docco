(function() {
<<<<<<< HEAD
  var destination, docco_scripts, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, path, showdown, sources, spawn, template, _ref;
=======
  var arg, args, css_file, destination, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, inline_css, l, languages, parse, path, showdown, sources, spawn, structured_output, template, version, _ref;
  version = '0.3.1';
>>>>>>> Adding support for various docco params: version, structured folders in docs dir, inlining of styles, and custom stylesheets.
